...
export default function SideBar() {
    ...
    <div>
      <div className="lg:hidden fixed top-4 left-4 z-50 ">
        <button
          ...
          className="text-xl text-[#7476d4] cursor-pointer"
        >
      ...
      >
        <div className="flex items-center space-x-2 border-b-2 border-b-gray-200 py-5 px-10 pt-5">
          <div className="w-10 h-10 rounded-full bg-[#7476d4] flex items-center justify-center ">
            <div className="text-white font-black text-xl">
              G
            </div>
          </div>

          <div className="text-[#7476d4]  font-[1000] tracking-wider text-medium">
            GOODFOOD
          </div>
        </div>

        <div className="text-gray-400 pt-10 pb-3 px-10">
          MENU
        </div>
       <div className="flex flex-col cursor-pointer gap-1 px-5">
      <Link
      href="#" className={
        `
        px-6 flex gap-4 p-3 group rounded-xl ${
  ...
  <div className="text-gray-500 group-hover:text-[#7476d4]">
    Dashboard
  </div>
</Link>
 ...
 href="#" className={
  ...
  <div className="text-gray-500 group-hover:text-[#7476d4]">
    Customer Review
       ...
       <div className="text-gray-400 pt-6 pb-3 px-5">
          OTHERS
        </div>
 ...
 href="#" className={
  ...
  <div className={
   ...
   <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24"><path fill="currentColor" d="M12 17q.425 0 .713-.288T13 16v-3q0-.425-.288-.712T12 12t-.712.288T11 13v3q0 .425.288.713T12 17m0-7q.425 0 .713-.288T13 9t-.288-.712T12 8t-.712.288T11 9t.288.713T12 10M6 21q-.825 0-1.412-.587T4 19v-9q0-.475.213-.9t.587-.7l6-4.5q.525-.4 1.2-.4t1.2.4l6 4.5q.375.275.588.7T20 10v9q0 .825-.588 1.413T18 21z"></path></svg>
  </div>
  <div className="text-gray-500 group-hover:text-[#7476d4]">
      Help
  </div>
